...
/// Test Context encapsulates a testing environment and allows tests to be
/// written once with swapable storage backends
/// 
/// The local fs is used which creates a temporary directory
/// The environment variable DELTA_RS_TEST_BACKEND is used to switch backends
/// Values:
/// LOCALFS
/// AZURE_GEN2
/// S3_LOCAL_STACK
/// 
/// AZURE_GEN2 requires AZURE_STORAGE_ACCOUNT_NAME, and
/// AZURE_STORAGE_ACCOUNT_KEY to be set and it will automatically create a
/// temporary local for tests and cleanup
/// 
/// S3_LOCAL_STACK requires Local stack to be setup
